...
| REQ-d00070 | dev-CDISC.md | CDASH Field Mapping Implementation | PENDING |
| REQ-d00071 | dev-CDISC.md | SDTM Domain Transformation Implementation | PENDING |
| REQ-d00072 | dev-CDISC.md | ODM-XML Export Implementation | PENDING |
| REQ-d00073 | dev-CDISC.md | Define-XML Metadata Generation | PENDING |
| REQ-d00074 | dev-CDISC.md | CDISC Controlled Terminology Implementation | PENDING |
| REQ-d00075 | dev-CDISC.md | EDC Data Transformation Specification | PENDING |
| REQ-d00076 | dev-CDISC.md | Clinical Data Export Formats | PENDING |
...
| REQ-p00041 | prd-standards.md | CDISC Standards Compliance | PENDING |
